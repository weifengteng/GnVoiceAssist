...
public class RippleLayout extends RelativeLayout {
    ...
    public RippleLayout(Context context) {
        super(context);
        Log.e("AAA", "111111111111111111111111111111111111" );
        init(context, null);
    }

    public RippleLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.e("AAA", "222222222222222222222222222222222222" );
        init(context, attrs);
    }

    public RippleLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        Log.e("AAA", "33333333333333333333333333333333333333" );
        init(context, attrs);
    }
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        //
        mRippleColor = typedArray.getColor(R.styleable.RippleLayout_colora,
    ...
    private void addAnimToRippleView(RippleView rippleView, int i) {
        ...
        // 颜色的alpha渐变动画
        final ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(rippleView, "alpha", 0.5f,
                0f);
