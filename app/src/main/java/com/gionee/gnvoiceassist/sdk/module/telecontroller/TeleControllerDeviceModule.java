 ...
 */
package com.gionee.gnvoiceassist.sdk.module.telecontroller;
...
public class TeleControllerDeviceModule extends BaseDeviceModule {
    ...
    public HashMap<String, Class<?>> supportPayload() {
        ...
        map.put(getNameSpace() + com.gionee.gnvoiceassist.sdk.module.telecontroller.ApiConstants.Directives.OperateBluetooth.NAME, com.gionee.gnvoiceassist.sdk.module.telecontroller.message.OperateBluetoothPayload.class);
        return map;
    }
