 ...
 */
package com.gionee.voiceassist.sdk.module.webbrowser;
...
import com.gionee.voiceassist.sdk.module.webbrowser.message.LaunchBrowserPayload;
...
public class WebBrowserDeviceModule extends BaseDeviceModule {
    ...
    public HashMap<String, Class<?>> supportPayload() {
        ...
        map.put(getNameSpace() + com.gionee.voiceassist.sdk.module.webbrowser.ApiConstants.Directives.LaunchBrowser.NAME, com.gionee.voiceassist.sdk.module.webbrowser.message.LaunchBrowserPayload.class);
        return map;
    }
