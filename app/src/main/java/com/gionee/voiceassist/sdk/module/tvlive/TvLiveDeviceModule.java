...
public class TvLiveDeviceModule extends BaseDeviceModule {
    ...
    public HashMap<String, Class<?>> supportPayload() {
        ...
        map.put(getNameSpace() + com.gionee.voiceassist.sdk.module.tvlive.ApiConstants.Directives.SwitchChannelByName.NAME, com.gionee.voiceassist.sdk.module.tvlive.message.SwitchChannelByNamePayload.class);
        map.put(getNameSpace() + com.gionee.voiceassist.sdk.module.tvlive.ApiConstants.Directives.SwitchChannelByNumber.NAME, com.gionee.voiceassist.sdk.module.tvlive.message.SwitchChannelByNumberPayload.class);
        return map;
    }
