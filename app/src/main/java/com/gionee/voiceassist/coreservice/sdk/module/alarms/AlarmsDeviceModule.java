 ...
 */
package com.gionee.voiceassist.coreservice.sdk.module.alarms;
...
public class AlarmsDeviceModule extends BaseDeviceModule {
    ...
    public HashMap<String, Class<?>> supportPayload() {
        ...
        map.put(getNameSpace() + com.gionee.voiceassist.coreservice.sdk.module.alarms.ApiConstants.Directives.SetAlarm.NAME, com.gionee.voiceassist.coreservice.sdk.module.alarms.message.SetAlarmPayload.class);
        map.put(getNameSpace() + com.gionee.voiceassist.coreservice.sdk.module.alarms.ApiConstants.Directives.SetTimer.NAME, com.gionee.voiceassist.coreservice.sdk.module.alarms.message.SetTimerPayload.class);
        map.put(getNameSpace() + com.gionee.voiceassist.coreservice.sdk.module.alarms.ApiConstants.Directives.ShowAlarms.NAME, com.gionee.voiceassist.coreservice.sdk.module.alarms.message.ShowAlarmsPayload.class);
        map.put(getNameSpace() + com.gionee.voiceassist.coreservice.sdk.module.alarms.ApiConstants.Directives.ShowTimers.NAME, com.gionee.voiceassist.coreservice.sdk.module.alarms.message.ShowTimersPayload.class);
        return map;
    }
